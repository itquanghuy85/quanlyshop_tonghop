    ...
    return await openDatabase(
      ...
      onUpgrade: (db, oldV, newV) async {
        ...
        if (oldV < 71) {
          try {
            await db.execute(
              'ALTER TABLE products ADD COLUMN labelNote TEXT',
            );
          } catch (e) {
